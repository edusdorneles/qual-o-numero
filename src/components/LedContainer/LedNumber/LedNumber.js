...
const LedNumber = ({ number }) => {
    ...
    return(
        <div className={`led-number ${errorExist && 'led-error'} ${ganhou && 'led-ganhou'}`}>
            <div className={`segment segment-a ${disabledSegments.includes("a") && "segment-disable" }`}>
            ...
            <div className={`segment segment-b ${disabledSegments.includes("b") && "segment-disable" }`}>
            ...
            <div className={`segment segment-c ${disabledSegments.includes("c") && "segment-disable" }`}>
                <svg width="17" height="65" viewBox="0 0 17 65" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={`segment segment-d ${disabledSegments.includes("d") && "segment-disable" }`}>
                <svg width="69" height="15" viewBox="0 0 69 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={`segment segment-e ${disabledSegments.includes("e") && "segment-disable" }`}>
            ...
            <div className={`segment segment-f ${disabledSegments.includes("f") && "segment-disable" }`}>
                <svg width="16" height="65" viewBox="0 0 16 65" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={`segment segment-g ${disabledSegments.includes("g") && "segment-disable" }`}>
